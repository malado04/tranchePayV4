  ...
  <header id="header" class="fixed-top d-flex align-items-center  bg-transparent">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          <li><a class="nav-link scrollto" id="text-white" href="{{route('dashboard')}}">Acceuil</a></li>
          <li><a class="nav-link scrollto" id="text-white" href="{{url('documentation')}}">Documentation</a></li>
          <li><a class="nav-link scrollto " id="text-white" href="{{url('commercant')}}">Commercant</a></li>
          <li><a class="nav-link scrollto" id="text-white" href="{{url('particulier')}}">Particulier</a></li>
          <li><a class="nav-link scrollto active" id="text-white" href="{{url('contact')}}">Contact</a></li>
          <li><a class="nav-link scrollto" id="text-white" href="{{route('login')}}">Connexion</a></li>
          <li><a class="nav-link scrollto" id="text-white" href="{{url('choixinscription')}}">creer compte</a></li>
        </ul>
