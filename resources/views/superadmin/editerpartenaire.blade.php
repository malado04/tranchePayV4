                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4 bold">
                        <div class="contenue" align="center">          
                            <div class="formsansicon">
                                ...
                                <form control="" class="form-group" method="post" action="{{route('supdatepartenaire',['suserpartenaire'=>$spartenaire->id])}}">
                                @csrf
                                    <!-- <div class="user"> -->
                                        <!-- <div .input-box> -->
                                            
                                            <input type="hidden" name="_method" value="put">
                                            <input type="text" name="prenom" id="prenom" class="form-control input" placeholder="Prenom du partenaire" value="{{$spartenaire->prenom}}" required="required">
