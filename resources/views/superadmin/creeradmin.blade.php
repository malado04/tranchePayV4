                            ...
                            <div class="formsansicon">
                                ...
                                @csrf
                                    ...
                                    <!-- <div class="user"> -->
                                        ...
                                        <!-- </div>
                                        <div .input-box> -->
                                            <input type="text" name="nom" class="form-control input" placeholder="Nom du admin" required="required">
                                        <!-- </div>
                                        <div .input-box> -->
                                            <input type="number" name="telephone" class="form-control input" placeholder="telephone du admin" required="required">
                                        <!-- </div>
                                        <div .input-box> --><!-- Password -->
                                            <input type="text" name="type" value="admin" style="display:none;" >

                                            <input id="password" class="form-control input" type="password" name="password" required="required" autocomplete="new-password" placeholder="Code PIN admin"/>

                                            <input id="password_confirmation" class="form-control input" type="password" name="password_confirmation" required="required" placeholder="Confirmation code PIN admin"/>
                                    <div align="center" >
