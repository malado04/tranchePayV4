                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4 bold">
                        <div class="contenue" align="center">          
                            <div class="formsansicon">
                                ...
                                @endforeach
                                @endif
                                <h2 class="texte">Editer commercant</h2>
                                <form control="" class="form-group" method="post" action="{{route('supdatecommercant',['susercommercant'=>$scommercant->id])}}">
                                @csrf
                                    <input type="hidden" name="_method" value="put">
                                    <input type="text" name="prenom" id="prenom" class="form-control input" placeholder="Prenom du commercant" value="{{$scommercant->prenom}}" required="required">
                                    <input type="text" name="nom" class="form-control input" placeholder="Nom du commercant" value="{{$scommercant->nom}}"required="required">
                                    <input type="text" name="boutique" class="form-control input" placeholder="Nom de la boutique" value="{{$scommercant->boutique}}" value="Pas de boutique">
                                    <input type="text" name="adresse" class="form-control input" placeholder="Adresse de la boutique" value="{{$scommercant->site}}"required="required">
                                    <input type="email" name="email" class="form-control input"   placeholder="Adresse mail commercant" value="{{$scommercant->email}}" required="required" id="email"/>
                                    <input type="text" name="type" value="commercant" style="display:none;" >
                                    <input type="number" name="telephone" class="form-control input" placeholder="Telephone du commercant" value="{{$scommercant->telephone}}"required="required">
