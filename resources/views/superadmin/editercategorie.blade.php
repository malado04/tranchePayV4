                ...
                <div class="container">
                    <div class="row bg-white" > 
                        ...
                        <div class="col-md-4">
                            ...
                            @endif
                            <form control="" class="form-group" method="post" action="{{route('supdatecategorie',['scategorie'=>$scategorie->id])}}" enctype="multipart/form-data">
                                @csrf
                                <input type="hidden" name="_method" value="put">
                                <input type="file" name="icon" class="form-control input" >
                                <input type="text" name="libelle" class="form-control input" value="{{$scategorie->libelle}}" placeholder="Libbelle" required="required">
                                <textarea name="description" id="description" cols="10" value="{{$scategorie->description}}" rows="5" class="form-control input" placeholder="La description" required="required"></textarea>
                        </div>
                        <div class="col-md-4"></div>
                    </div>
                    <div class="row">
