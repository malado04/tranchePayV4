                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4 bold">
                        <div class="contenue" align="center">          
                            <div class="formsansicon">
                                ...
                                @endforeach
                                @endif
                                <h2 class="texte">Editer admin</h2>
                                <form control="" class="form-group" method="post" action="{{route('supdateadmin',['useradmin'=>$admin->id])}}">
                                @csrf
                                
                                    <input type="hidden" name="_method" value="put">
                                    <input type="text" name="prenom" id="prenom" class="form-control input" placeholder="Prenom du admin" value="{{$admin->prenom}}" required="required">
                               
                                    <input type="text" name="nom" class="form-control input" placeholder="Nom du admin" value="{{$admin->nom}}"required="required">
                               
                                    <input type="text" name="type" value="admin" style="display:none;" >

                                    <input type="number" name="telephone" class="form-control input" placeholder="Telephone du admin" value="{{$admin->telephone}}"required="required">

                                    <input id="password" class="form-control input" type="password" name="password" required="required" autocomplete="new-password" placeholder="Nouveau code PIN admin"/>

                                    <input id="password_confirmation" class="form-control input" type="password" name="password_confirmation" required="required" placeholder="Confirmation nouveau code PIN admin"/>
                                    <div align="center" >
