<x-guest-layout>
    <x-auth-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <!-- boutique -->
            <div class="mt-4">
                <x-label for="boutique" :value="__('Boutique')" />

                <x-input id="boutique" class="block mt-1 w-full" type="text" name="boutique" :value="old('boutique')" required autofocus />
            </div>

            <!-- adresse boutique -->
            <div class="mt-4">
                <x-label for="site" :value="__('Adresse de la boutique')" />
