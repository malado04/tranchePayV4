    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div class="row textealigner">
                <div class="col-md-1"></div>
                    <div class="col-md-10">       
                        ...
                        @if($categorie->id == $_GET['categorie'])
                            <H1>Listes des partenaires de {{$categorie->libelle}}</H1>
                        @endif         
                        @endforeach 
                    </div>
                <div class="col-md-1"></div>
            ...
            @if($partenaire->type == 'partenaire')
                @foreach ($listecategorie as $categorie)
                @if($categorie->id == $_GET['categorie'])
                    @if(strpos($partenaire->categorie, $categorie->id) !==false)

                        <div style="display: inline-flex;width:32% ;">
                            <div style ="height:100%; width:100% ;  margin:10px; border: 5px solid silver; text-align:center; background-color: rgb(0, 0, 0);" >
                                <span  class="text-center listepartenaire " > {{$partenaire->nom}} </span>
                                <img class="imgptn" src="{{asset ('logo/'.$partenaire->image)}}">
                            </div> 
                        </div>  
                    @endif         
                @endif         
