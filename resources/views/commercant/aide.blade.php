            ...
            <div id="content">
                ...
                @if(session()->has("succescreate"))
                    ...
                    <div class="row bg-white" > 
                        ...
                        <div class="col-md-4">
                                    <form control="" class="form-group" method="post" action="{{route('formaide')}}">
                                    @csrf
                                    <input type="text" name="sujet" class="form-control input" placeholder="Sujet" required="required">
                                    <textarea name="message" id="message" cols="10" rows="5" class="form-control input" placeholder="Votre message"></textarea>
