                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4 bold">
                        <div class="contenue" align="center">          
                            <div class="formsansicon">
                                ...
                                <form control="" class="form-group" method="post" action="{{route('creationcommercantad')}}" enctype="multipart/form-data">
                                @csrf
                                    ...
                                    <input id="password_confirmation" class="form-control input" type="password" name="password_confirmation" required="required" placeholder="Confirmation code PIN commercant"/>
                                    <div align="center" >
