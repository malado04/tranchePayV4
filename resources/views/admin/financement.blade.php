                        ...
                        <table id="example" class="table table-striped" style="width:100%">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col">Adresse Boutique</th>
                                    <th scope="col">Adresse livraison</th>
                                    <th scope="col">Prix</th>
                                    <th scope="col">Montant verset</th>
                                    <th scope="col">Derniere delai</th>
                                    <th scope="col">montant a payer</th>
                                    <th scope="col">Prenom & NOM client</th>
                                    <th scope="col">Telephone client</th>
                                </tr>
                            </thead>
                            <tbody>
                                @foreach ($listefinancement as $financement)
                                <tr>
                                    <th>{{$financement->id}}</th>
                                    <th>{{$financement->nomproduit}}</th>
                                    <th>{{$financement->lientproduit}}</th>
                                    <th>{{$financement->adresseboutique}}</th>
                                    <th>{{$financement->adresselivraison}}</th>
                                    <th>{{$financement->prix}}</th>
                                    <th>{{$financement->montantverset}}</th>
                                    <th>{{$financement->nombremois}}</th>
                                    <th>{{$financement->montantpayer}}</th>
                                    <th>{{$financement->user->prenom}} {{$financement->user->nom}}</th>
                                    <th>{{$financement->user->telephone}}</th>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
