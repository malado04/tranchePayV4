                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4 bold">
                        <div class="contenue" align="center">          
                            <div class="formsansicon">
                                ...
                                <form control="" class="form-group" method="post" action="{{route('updateclient',['userclient'=>$client->id])}}">
                                @csrf
                                    <input type="hidden" name="_method" value="put">
                                    <input type="text" name="prenom" id="prenom" class="form-control input" placeholder="Prenom du client" value="{{$client->prenom}}" required="required">
                        
                                    <input type="text" name="nom" class="form-control input" placeholder="Nom du client" value="{{$client->nom}}"required="required">
                                
                                    <input type="text" name="type" value="client" style="display:none;" >

                                    <input type="number" name="telephone" class="form-control input" placeholder="Telephone du client" value="{{$client->telephone}}" required="required">
