                    ...
                    <div class="col-md-8">
                        <table id="example" class="table table-striped" style="width:100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <th>{{$commandes->id}}</th>
                                    <th>{{$commandes->montantverset}}</th>
                                    <th>{{$commandes->created_at}}</th>
                                    <th>{{$commandes->user->prenom}} {{$commandes->user->nom}}</th>
                                    <th>{{$commandes->user->telephone}}</th>
                                </tr>
                                @endforeach
                                @foreach ($listeversement as $versement)
                                <tr>
                                    <th>{{$versement->enregistrercommande->id}}</th>
                                    <th>{{$versement->verset}}</th>
                                    <th>{{$versement->created_at}}</th>
                                    <th>{{$versement->user->prenom}} {{$versement->user->nom}}</th>
                                    <th>{{$versement->user->telephone}}</th>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
