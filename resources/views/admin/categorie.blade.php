...
<ul class="navbar-nav bgnavouzin sidebar  sidebar-dark " id="accordionSidebar">
    ...
    <div class="row textealigner">
        ...
        <div class="col-md-6">
            ...
            @endif
            <a href="{{route('creercategoriead')}}" class="h1transaction btn btn-warning">Creer categorie</a>
        </div>
        <div class="col-md-3"></div>
    </div>
                        ...
                        <table id="example" class="table table-striped" style="width:100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <th>
                                        <a class="btn btn-info" href="{{route('editcategorie',['categorie'=>$categorie->id])}}" style="width:40px"> <i class="fas fa-user-edit"></i>  <a>
                                        ...
                                        <form id="form-{{$categorie->id}}"action="{{route('supprimercategorie',['suppcategorie'=>$categorie->id])}}" method="post">
                                            @csrf
