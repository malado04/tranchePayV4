    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bgnavouzin sidebar  sidebar-dark " id="accordionSidebar">
            ...
            <li class="nav-item jaune jaunehover">
                <a class="nav-link collapsed" href="{{ route('pagecategoriead') }}" >
                    <span>Categorie </span>
                </a> 
            </li>
            ...
            <div id="content">
                ...
                <div class="container">
                    <div class="row bg-white" > 
                        ...
                        <div class="col-md-4">
                            <h2 class="texte">Mise a jour categorie</h2>
                            @if(session()->has("updatereussit"))
                            <div class="alert alert-success  text-center form-control "  >
                                {{session()->get('updatereussit')}}
                            </div>
                            @endif
                            <form control="" class="form-group" method="post" action="{{route('updatecategorie',['categorie'=>$categorie->id])}}" enctype="multipart/form-data">
                                @csrf
                                <input type="hidden" name="_method" value="put">
                                <input type="file" name="icon" class="form-control input" value="{{$categorie->icon}}" required="required">
                                <input type="text" name="libelle" class="form-control input" value="{{$categorie->libelle}}" placeholder="Libbelle" required="required">
                                <textarea name="description" id="description" cols="10" value="{{$categorie->description}}" rows="5" class="form-control input" placeholder="La description" required="required"></textarea>
                        </div>
                        <div class="col-md-4"></div>
                    </div>
                    <div class="row">
