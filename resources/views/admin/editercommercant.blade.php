                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4 bold">
                        <div class="contenue" align="center">          
                            <div class="formsansicon">
                                ...
                                <form control="" class="form-group" method="post" action="{{route('updatecommercant',['usercommercant'=>$comercant->id])}}">
                                @csrf
                                    <input type="hidden" name="_method" value="put">
                                    <input type="text" name="prenom" id="prenom" class="form-control input" placeholder="Prenom du commercant" value="{{$comercant->prenom}}" required="required">
                                    <input type="text" name="nom" class="form-control input" placeholder="Nom du commercant" value="{{$comercant->nom}}"required="required">
