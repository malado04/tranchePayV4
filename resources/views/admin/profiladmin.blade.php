                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4 bold">
                        <div class="contenue" align="center">          
                            ...
                            @endif
                                ...
                                <form control="" class="form-group" method="post" action="{{route('updateadminad')}}">
                                @csrf
                                    <!-- <div class="user"> -->
                                        <!-- <div .input-box> -->
                                            <input type="password" name="ancien_code_pin" class="form-control input" placeholder="Ancien code PIN" id="old_password" required="required">
                                        <!-- </div>
                                        <div .input-box> -->
                                            <input type="password" name="nouveau_code_pin" class="form-control input" placeholder="Nouveau code PIN" id="new_password" required="required">
                                        <!-- </div>
                                        <div .input-box> -->
                                            <input type="password" name="confirmation_code_pin" class="form-control input" placeholder="Confirme le code PIN" id="confirm_password" required="required">
