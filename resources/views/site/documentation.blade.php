...
<body>
    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto active" href="{{route('documentation')}}">Documentation</a></li>
          ...
          <li><a class="nav-link scrollto" href="#">creer compte</a></li>
        </ul>
  ...
  <section id="hero">
    ...
    <div class="container">
        <div class="bg-rgba p-3 col-lg-12 order-1 order-lg-2 hero-img" data-aos="zoom-out" data-aos-delay="300">
        	<div class="row">
          <div class="col-md-9"><h1 class="row"> Documentations </h1> </div>
        ...
        <div class="col-lg-3 pt-5 pt-lg-0 order-2 order-lg-1 d-flex align-items-center">
          <div data-aos="zoom-out bg-danger">
            <div class="list-group" id="myList" role="tablist" style="width: 100%">
			  <a class="list-group-item list-group-item-action active" data-toggle="list" href="#home" role="tab">Que voulez-vous savoir ?</a>
			  <a class="list-group-item list-group-item-action" data-toggle="list" href="#profile" role="tab">Présentation <span style="float: right; font-size: 25px; ">></span> </a>
			  <a class="list-group-item list-group-item-action" data-toggle="list" href="#messages" role="tab">Services <span style="float: right; font-size: 25px; ">></span></a>
			  <a class="list-group-item list-group-item-action" data-toggle="list" href="#settings" role="tab">L'API <span style="float: right; font-size: 25px; ">></span></a>
			  <a class="list-group-item list-group-item-action" data-toggle="list" href="#settings" role="tab">Commerçant <span style="float: right; font-size: 25px; ">></span></a>
			  <a class="list-group-item list-group-item-action" data-toggle="list" href="#settings" role="tab">Particulier <span style="float: right; font-size: 25px; ">></span></a>
			  <a class="list-group-item list-group-item-action" data-toggle="list" href="#settings" role="tab">Partenaire <span style="float: right; font-size: 25px; ">></span></a>
			</div>
			<script>
			  $(function () {
